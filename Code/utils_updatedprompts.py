...
def get_language_code(language_name):
    ...
    language_name = language_name.lower()  # Convert to lowercase to handle case-insensitivity
...
def get_Google_translation(source_lang, target_lang, text):
    try:
        ...
        GL_reference = translator.translate(text)
        return GL_reference
...
def one_chunk_reflect_on_translation(
    ...
    Args:
        ...
        GL_reference (str): The translation from Google Translate to be used as reference. 
...
The final style and tone of the translation should match the style of {target_lang} colloquially spoken in {country}. You also have the option of using the translation by Google Translate from {GL_reference} as reference. 
...
def one_chunk_translate_text(
    ...
    GL_reference = get_Google_translation(source_lang, target_lang, source_text)

    reflection = one_chunk_reflect_on_translation(
        source_lang, target_lang, source_text, translation_1,GL_reference, country
    )
...
def multichunk_reflect_on_translation(
    ...
    Args:
        ...
        GL_reference (List[str]): The translation from Google Translate to be used as reference. 
        country (str): Country specified for target language.
...
df.to_csv('random_sample_combinedGL_TA.csv', index=False)