...
def get_Google_translation(source_lang: str, target_lang: str, source_text: str)->str:
    GL_reference = GoogleTranslator(source= source_lang, target= target_lang).translate(source_text)
    return GL_reference
